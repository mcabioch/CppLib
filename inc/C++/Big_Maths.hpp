...
#define BIG_E                                                                                      \
     ...
     */
    inline Big sq(const Big& a) { return pow(a, Big(2)); }
     ...
     */
    inline Big sqrt(const Big& a) { return nroot(a, 2); }
     ...
     */
    inline Big ppcm(const Big& a, const Big& b) { return (a * b) / pgcd(a, b); }
     ...
     */
    inline bool isDivisor(const Big& a, const Big& b) { return ((a % b) == Big(0)); }
     ...
     */
    inline Big abs(const Big& a) { return (a < Big(0)) ? (a * Big(-1)) : a; }
