...
namespace mcd
{
     ...
     */
    enum class Tile { NONE = 0, OBSTACLE, GROUND, ERROR };
    ...
    class Map {
         ...
         *
         *		\return			Return a MapMove, .next to know if it can continue,
         *.end to know if it's the end
         */
         ...
         *		\return			Return \b true or \b false
         */
        bool isOnGround(size_t id) { return isFree(_entities[id].first); }
        /*!
         ...
         *		\return			Return \b true or \b false
         */
        bool isOnGround(const Point& pt) { return isFree(pt); }
