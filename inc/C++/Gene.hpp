 ...
 *
 */
#ifndef HEADER_MCD_GENETIC_GENE
#define HEADER_MCD_GENETIC_GENE

#include "C++lib.hpp"

namespace mcd::genetic
{
    /*!
     * \class	Gene
    ...
    class Gene {
        ...
        enum GeneType { FLOAT, INT, BOOL, RANGED_INT, RANGED_FLOAT, LISTED, STATIC };
        ...
        friend bool operator==(const Gene& g1, const Gene& g2) { return (g1._name == g2._name); }
