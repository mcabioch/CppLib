...
namespace mcd
{
     ...
     *		\param[in]		x1		X position of the first rectangle's left
     *corner \param[in]		y1		Y position of the first rectangle's left corner
     *		\param[in]		w1		Width of the first rectangle
     *		\param[in]		h1		Height of the first rectangle
     *		\param[in]		x2		X position of the second rectangle's left
     *corner \param[in]		y2		Y position of the second rectangle's left corner
