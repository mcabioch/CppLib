...
namespace mcd::entities
{
    ...
    class Animal : public Entity, public Hostile {
        ...
        /*!
         * \brief	Verify the collisions between a circle around this Animal and an other
         *animal \param[in]		other		The obstacle to verify
        ...
        virtual bool attack(Entity* target = nullptr) override {
            if (target == nullptr) { target = getTarget(); }
