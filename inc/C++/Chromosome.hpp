 ...
 *
 */
#ifndef HEADER_MCD_GENETIC_CHROMOSOME
#define HEADER_MCD_GENETIC_CHROMOSOME
...
namespace mcd::genetic
{
    ...
    class Chromosome {
        ...
        friend std::ostream& operator<<(std::ostream& os, const Chromosome& c) {
            ...
            for (auto& g : c._genes1) { os << g << "\n"; }

            os << c._genes2.size();

            for (auto& g : c._genes2) { os << "\n" << g; }
...
#endif   // HEADER_MCD_GENETIC_CHROMOSOME
