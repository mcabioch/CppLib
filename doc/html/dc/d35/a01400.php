...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('dc/d35/a01400.php','../../'); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<a href="../../d7/d1c/a01397.php">List of all members</a>  </div>
...
<p>A template class to test if T is a std::shared_ptr&lt;thread&gt;, a std::unique_ptr&lt;thread&gt;, a std::weak_ptr&lt;thread&gt; or a thread*.  
 <a href="../../dc/d35/a01400.php#details">More...</a></p>

<p><code>#include &lt;pointers.hpp&gt;</code></p>
<table class="memberdecls">
<tr class="heading"><td colspan="2"><h2 class="groupheader"><a name="pub-static-attribs"></a>
Static Public Attributes</h2></td></tr>
<tr class="memitem:aeaf71256c26f5b5be4a5e5db9035500b"><td class="memItemLeft" align="right" valign="top">static const bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dc/d35/a01400.php#aeaf71256c26f5b5be4a5e5db9035500b">value</a> = false</td></tr>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">const bool <a class="el" href="../../dc/d35/a01400.php">mcd::Check::is_thread_ptr</a>&lt; T &gt;::value = false</td>
        </tr>
      </table>
  </td>
...
<div id="nav-path" class="navpath"><!-- id is needed for treeview function! -->
	<ul>
		<li class="navelem"><a class="el" href="../../db/d12/a00268.php">mcd</a></li><li class="navelem"><a class="el" href="../../dd/d86/a00271.php">Check</a></li><li class="navelem"><a class="el" href="../../dc/d35/a01400.php">is_thread_ptr</a></li>
		<li class="footer">
			<?php
				echo $text;
			?>
