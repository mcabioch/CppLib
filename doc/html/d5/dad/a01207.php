...
<a href="../../d7/d5a/a01204.php">List of all members</a>  </div>
...
<p>A template class to test if T is a special struct.  
 <a href="../../d5/dad/a01207.php#details">More...</a></p>

<p><code>#include &lt;check.hpp&gt;</code></p>
<table class="memberdecls">
<tr class="heading"><td colspan="2"><h2 class="groupheader"><a name="pub-static-attribs"></a>
Static Public Attributes</h2></td></tr>
<tr class="memitem:adb3d78bf0acb5e62f39d063521210081"><td class="memItemLeft" align="right" valign="top">static const bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../d5/dad/a01207.php#adb3d78bf0acb5e62f39d063521210081">value</a></td></tr>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">const bool <a class="el" href="../../d5/dad/a01207.php">mcd::check::is_special_struct</a>&lt; T &gt;::value</td>
        </tr>
      </table>
  </td>
...
<div id="nav-path" class="navpath"><!-- id is needed for treeview function! -->
	<ul>
		<li class="navelem"><a class="el" href="../../db/d12/a00268.php">mcd</a></li><li class="navelem"><a class="el" href="../../d0/d19/a00273.php">check</a></li><li class="navelem"><a class="el" href="../../d5/dad/a01207.php">is_special_struct</a></li>
		<li class="footer">
			<?php
				echo $text;
			?>
