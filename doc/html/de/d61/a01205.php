...
<div id="nav-path" class="navpath"><!-- id is needed for treeview function! -->
	<ul>
		<li class="navelem"><a class="el" href="../../db/d12/a00268.php">mcd</a></li><li class="navelem"><a class="el" href="../../dd/d86/a00271.php">Check</a></li><li class="navelem"><a class="el" href="../../de/d61/a01205.php">is_special_struct</a></li>
		<li class="footer">
			<?php
				echo $text;
			?>
