...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('d6/de1/a00233.php','../../'); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
Classes</h2></td></tr>
<tr class="memitem:"><td class="memItemLeft" align="right" valign="top">class &#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../d1/df4/a01422.php">mcd::tests::Test</a></td></tr>
<tr class="memdesc:"><td class="mdescLeft">&#160;</td><td class="mdescRight">A static class to test code.  <a href="../../d1/df4/a01422.php#details">More...</a><br /></td></tr>
...
<tr class="separator:"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:dd/d56/a00274"><td class="memItemLeft" align="right" valign="top"> &#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d56/a00274.php">mcd::tests</a></td></tr>
<tr class="separator:"><td class="memSeparator" colspan="2">&#160;</td></tr>
</table><table class="memberdecls">
...
<tr class="memitem:a31dc59c312f6beaf52e720c5a7dcc017"><td class="memItemLeft" align="right" valign="top">#define&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../d6/de1/a00233.php#a31dc59c312f6beaf52e720c5a7dcc017">unit_in</a>(VALUE,  ARRAY)&#160;&#160;&#160;    <a class="el" href="../../d1/df4/a01422.php#a79a117fd4376fc9d22a777900375e988">mcd::tests::Test::in</a>(VALUE, ARRAY, {false, #ARRAY, __FILE__, __PRETTY_FUNCTION__, __LINE__})</td></tr>
...
<b>Value:</b><div class="fragment"><div class="line">    <a class="code" href="../../d1/df4/a01422.php#a9b581c6619cbb7660c0c0d509a4a979d">mcd::tests::Test::addTest</a>(                                                                     \</div>
...
<b>Value:</b><div class="fragment"><div class="line">    <a class="code" href="../../d1/df4/a01422.php#abfd0b19e1a6b68854276138b66f0b757">mcd::tests::Test::addThrow</a>(                                                                    \</div>
...
<div class="memproto">
      <table class="memname">
        ...
        <tr>
          <td></td>
          <td>)</td>
          <td></td><td>&#160;&#160;&#160;    <a class="el" href="../../d1/df4/a01422.php#a79a117fd4376fc9d22a777900375e988">mcd::tests::Test::in</a>(VALUE, ARRAY, {false, #ARRAY, __FILE__, __PRETTY_FUNCTION__, __LINE__})</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<b>Value:</b><div class="fragment"><div class="line">    <a class="code" href="../../d1/df4/a01422.php#a79a117fd4376fc9d22a777900375e988">mcd::tests::Test::in</a>(VALUE,                                                                    \</div>
...
<div class="ttc" id="aa01422_php_a9b581c6619cbb7660c0c0d509a4a979d"><div class="ttname"><a href="../../d1/df4/a01422.php#a9b581c6619cbb7660c0c0d509a4a979d">mcd::tests::Test::addTest</a></div><div class="ttdeci">static void addTest(const Test_struct &amp;test)</div><div class="ttdoc">Add a test analyze to an array.</div></div>
<div class="ttc" id="aa01422_php_abfd0b19e1a6b68854276138b66f0b757"><div class="ttname"><a href="../../d1/df4/a01422.php#abfd0b19e1a6b68854276138b66f0b757">mcd::tests::Test::addThrow</a></div><div class="ttdeci">static void addThrow(const std::string &amp;instr, const std::string &amp;except, const Test_struct &amp;test)</div><div class="ttdoc">Add a throw test with addTest.</div><div class="ttdef"><b>Definition:</b> Test.hpp:100</div></div>
<div class="ttc" id="aa01422_php_a79a117fd4376fc9d22a777900375e988"><div class="ttname"><a href="../../d1/df4/a01422.php#a79a117fd4376fc9d22a777900375e988">mcd::tests::Test::in</a></div><div class="ttdeci">static void in(const T &amp;value, const U &amp;array, const Test_struct &amp;test, bool start=false)</div><div class="ttdoc">Test if a value is or isn't in an array.</div><div class="ttdef"><b>Definition:</b> Test.hpp:115</div></div>
