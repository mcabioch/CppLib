...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('dd/d39/a01271.php','../../'); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<a href="../../dc/dd9/a01268.php">List of all members</a>  </div>
  <div class="headertitle">
<div class="title">mcd::RSA Class Reference</div>  </div>
</div><!--header-->
<div class="contents">

<p>A class to use the <a class="el" href="../../dd/d39/a01271.php" title="A class to use the RSA algorithm for encryption.">RSA</a> algorithm for encryption.  
 <a href="../../dd/d39/a01271.php#details">More...</a></p>

<p><code>#include &lt;cryptage.hpp&gt;</code></p>
<div class="dynheader">
Inheritance diagram for mcd::RSA:</div>
<div class="dyncontent">
<div class="center"><img src="../../da/d00/a01270.png" border="0" usemap="#amcd_1_1RSA_inherit__map" alt="Inheritance graph"/></div>
...
<div class="dyncontent">
<div class="center"><img src="../../d6/d16/a01269.png" border="0" usemap="#amcd_1_1RSA_coll__map" alt="Collaboration graph"/></div>
...
<area shape="rect" href="../../d7/d88/a01255.php" title="A class to be the parent for every crypt class." alt="" coords="34,96,129,123"/>
<area shape="rect" href="../../d1/dcd/a01351.php" title="A class to let some other not to be copyable." alt="" coords="5,13,136,39"/>
...
<tr class="memitem:a022907735103df44ce25774a289cede1"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#a022907735103df44ce25774a289cede1">RSA</a> ()</td></tr>
<tr class="separator:a022907735103df44ce25774a289cede1"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a9d09972656fd75b2377a173a30692db6"><td class="memItemLeft" align="right" valign="top">virtual&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#a9d09972656fd75b2377a173a30692db6">~RSA</a> ()</td></tr>
<tr class="separator:a9d09972656fd75b2377a173a30692db6"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a7fdf2f24700983208b6bfab8df8ef911"><td class="memItemLeft" align="right" valign="top">std::string&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#a7fdf2f24700983208b6bfab8df8ef911">getPublic</a> () const</td></tr>
<tr class="memdesc:a7fdf2f24700983208b6bfab8df8ef911"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the public key.  <a href="../../dd/d39/a01271.php#a7fdf2f24700983208b6bfab8df8ef911">More...</a><br /></td></tr>
<tr class="separator:a7fdf2f24700983208b6bfab8df8ef911"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ac38c1c5dff307a8dd9ce9c00b8df8b87"><td class="memItemLeft" align="right" valign="top">std::string&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#ac38c1c5dff307a8dd9ce9c00b8df8b87">getPrivate</a> () const</td></tr>
<tr class="memdesc:ac38c1c5dff307a8dd9ce9c00b8df8b87"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the private key.  <a href="../../dd/d39/a01271.php#ac38c1c5dff307a8dd9ce9c00b8df8b87">More...</a><br /></td></tr>
<tr class="separator:ac38c1c5dff307a8dd9ce9c00b8df8b87"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a4fcb230195d7b3fb73b8f62488dcc2e5"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#a4fcb230195d7b3fb73b8f62488dcc2e5">setPublic</a> (const std::string &amp;key=&quot;&quot;)</td></tr>
<tr class="memdesc:a4fcb230195d7b3fb73b8f62488dcc2e5"><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the public key.  <a href="../../dd/d39/a01271.php#a4fcb230195d7b3fb73b8f62488dcc2e5">More...</a><br /></td></tr>
<tr class="separator:a4fcb230195d7b3fb73b8f62488dcc2e5"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:aa9cb76b3198a8127bc0c771e3eb70b2d"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#aa9cb76b3198a8127bc0c771e3eb70b2d">setPrivate</a> (const std::string &amp;key=&quot;&quot;)</td></tr>
<tr class="memdesc:aa9cb76b3198a8127bc0c771e3eb70b2d"><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the private key.  <a href="../../dd/d39/a01271.php#aa9cb76b3198a8127bc0c771e3eb70b2d">More...</a><br /></td></tr>
<tr class="separator:aa9cb76b3198a8127bc0c771e3eb70b2d"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ad080bbc2c65c9690f38fa376ca65a985"><td class="memItemLeft" align="right" valign="top">virtual std::string&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#ad080bbc2c65c9690f38fa376ca65a985">crypt</a> (const std::string &amp;message) override</td></tr>
<tr class="memdesc:ad080bbc2c65c9690f38fa376ca65a985"><td class="mdescLeft">&#160;</td><td class="mdescRight">Overload of the crypt <a class="el" href="../../d7/d88/a01255.php" title="A class to be the parent for every crypt class.">Crypto</a>'s method.  <a href="../../dd/d39/a01271.php#ad080bbc2c65c9690f38fa376ca65a985">More...</a><br /></td></tr>
<tr class="separator:ad080bbc2c65c9690f38fa376ca65a985"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ad831bd26ceeff7ad460bcabcad213155"><td class="memItemLeft" align="right" valign="top">virtual std::string&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#ad831bd26ceeff7ad460bcabcad213155">decrypt</a> (const std::string &amp;message) override</td></tr>
<tr class="memdesc:ad831bd26ceeff7ad460bcabcad213155"><td class="mdescLeft">&#160;</td><td class="mdescRight">Overload of the decrypt <a class="el" href="../../d7/d88/a01255.php" title="A class to be the parent for every crypt class.">Crypto</a>'s method.  <a href="../../dd/d39/a01271.php#ad831bd26ceeff7ad460bcabcad213155">More...</a><br /></td></tr>
...
<tr class="memitem:ae37f658e3ba447726e0a0abd0f1ac5c8"><td class="memItemLeft" align="right" valign="top">std::string&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#ae37f658e3ba447726e0a0abd0f1ac5c8">publicK</a></td></tr>
<tr class="separator:ae37f658e3ba447726e0a0abd0f1ac5c8"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a41496cdf1557d2e3dda4d0f414738af5"><td class="memItemLeft" align="right" valign="top">std::string&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../dd/d39/a01271.php#a41496cdf1557d2e3dda4d0f414738af5">privateK</a></td></tr>
<tr class="separator:a41496cdf1557d2e3dda4d0f414738af5"><td class="memSeparator" colspan="2">&#160;</td></tr>
</table>
<a name="details" id="details"></a><h2 class="groupheader">Detailed Description</h2>
<div class="textblock"><p>A class to use the <a class="el" href="../../dd/d39/a01271.php" title="A class to use the RSA algorithm for encryption.">RSA</a> algorithm for encryption. </p>
...
<p>Overload of the decrypt <a class="el" href="../../d7/d88/a01255.php" title="A class to be the parent for every crypt class.">Crypto</a>'s method. </p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
<p>Implements <a class="el" href="../../d7/d88/a01255.php#a4d131065e81529530b7907ba397af30d">mcd::Crypto</a>.</p>
...
<div id="nav-path" class="navpath"><!-- id is needed for treeview function! -->
	<ul>
		<li class="navelem"><a class="el" href="../../db/d12/a00268.php">mcd</a></li><li class="navelem"><a class="el" href="../../dd/d39/a01271.php">RSA</a></li>
		<li class="footer">
			<?php
				echo $text;
			?>
