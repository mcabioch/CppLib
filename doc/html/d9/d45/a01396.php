...
<a href="../../d3/d92/a01393.php">List of all members</a>  </div>
...
<p>A template class to test if T is a std::shared_ptr, a std::unique_ptr or a std::weak_ptr.  
 <a href="../../d9/d45/a01396.php#details">More...</a></p>

<p><code>#include &lt;pointers.hpp&gt;</code></p>
<table class="memberdecls">
<tr class="heading"><td colspan="2"><h2 class="groupheader"><a name="pub-static-attribs"></a>
Static Public Attributes</h2></td></tr>
<tr class="memitem:a76170894810e15b11dafb7f34965aef4"><td class="memItemLeft" align="right" valign="top">static const bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="../../d9/d45/a01396.php#a76170894810e15b11dafb7f34965aef4">value</a> = false</td></tr>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">const bool <a class="el" href="../../d9/d45/a01396.php">mcd::Check::is_minded_ptr</a>&lt; T &gt;::value = false</td>
        </tr>
      </table>
  </td>
...
<div id="nav-path" class="navpath"><!-- id is needed for treeview function! -->
	<ul>
		<li class="navelem"><a class="el" href="../../db/d12/a00268.php">mcd</a></li><li class="navelem"><a class="el" href="../../dd/d86/a00271.php">Check</a></li><li class="navelem"><a class="el" href="../../d9/d45/a01396.php">is_minded_ptr</a></li>
		<li class="footer">
			<?php
				echo $text;
			?>
